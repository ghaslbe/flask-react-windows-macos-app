...
if __name__ == '__main__':
    init_db()
    print("Starte Benutzerverwaltung mit System Tray...")
    print(f"Datenbank-Speicherort: {DATABASE}")
    print("Die Anwendung öffnet sich automatisch in Ihrem Browser...")
    
    if TRAY_AVAILABLE:
        print("System Tray Icon wird angezeigt...")
        print("Rechtsklick auf Tray-Icon für Optionen")
    
    print("Zum Beenden: Tray-Icon → Beenden oder Ctrl+C")
